...
namespace Edebit\Payment\Model\Ach\Ui;
...
{
    public const METHOD_CODE = 'ach';
    private const METHOD_KEY_ACTIVE = 'payment/ach/active';
    private const METHOD_KEY_ENV = 'payment/ach/environment';
        ...
        return [
            'payment' => [
                self::METHOD_CODE => [
                    ...
                    'imageUrl' => $this->assetRepo->getUrl("Edebit_Payment::images/ach.png"),
    ...
    private function getValidationServices(): array
    {
        ...
        if (empty($clientId) || empty($merchantApiKey)) {
            throw new ErrorException('Client ID or Merchant missing. Provide both to proceed.');
        }
        ...
        $merchant = $this->httpService->getValidationServices('ACH');
